...
An npm script runs a [Node function](https://github.com/j0lv3r4/jolvera.dev/blob/master/posts/json-feed.js) that generates the feed as a static file when it&#8217;s deploying in Now.
...
// package.json
  ...
  "scripts": {
    "dev": "next",
    "build": "next build",
    "build:rss": "node ./.next/serverless/posts/json-feed.js",
